...
\draw (nt) -- ($(nt)+(1.25,-1/2)$);
\node (rec) at ($(A2) + (-1cm,1cm)$) {\footnotesize\fontfamily{phv}\selectfont recombination};
\draw (rec) -- ($(rec)+(1,-1/2)$);
\node (coal) at ($(A2) + (-1cm,-0.5cm)$) {\footnotesize\fontfamily{phv}\selectfont coalescence};
\draw (coal) -- ($(coal)+(1,-1/3)$);
\end{tikzpicture}
\caption{
...
\node (rec) at ($(A2) + (-1cm,2cm)$) {\footnotesize\fontfamily{phv}\selectfont recombination};
\draw (rec) -- ($(rec)+(2,-1/2)$);
\node (mut) at ($(A2) + (-1cm,0cm)$) {\footnotesize\fontfamily{phv}\selectfont migration};
\draw (mut) -- ($(mut)+(1.25,-1/2)$);
\node (coal) at ($(A2) + (3cm,0cm)$) {\footnotesize\fontfamily{phv}\selectfont coalescence};
\draw (coal) -- ($(coal)+(-1.75,-1)$);
\end{tikzpicture}
\caption{
