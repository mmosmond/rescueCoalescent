...
\centering
\begin{tikzpicture}
\node[] (A1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.2_k100_u0_m0.pdf}};
\node[below = -1cm of A1] (A2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.2_k100_u0_m0.pdf}};
\node[right = 0cm of A1] (B1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.2_k1_u0_m0.pdf}};
\node[right = 0cm of A2] (B2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.2_k1_u0_m0.pdf}};
\node[below = 0cm of A2] (C1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.13_k100_u0_m0.pdf}};
\node[below = -1cm of C1] (C2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.13_k100_u0_m0.pdf}};
\node[right = 0cm of C1] (D1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.13_k1_u0_m0.pdf}};
\node[right = 0cm of C2] (D2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.13_k1_u0_m0.pdf}};
...
\centering
\begin{tikzpicture}
\node[] (A1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.2_k0_u0.0001_m0.pdf}};
\node[below = -1cm of A1] (A2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.2_k0_u0.0001_m0.pdf}};
\node[right = 0cm of A1] (B1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.2_k0_u0.00001_m0.pdf}};
\node[right = 0cm of A2] (B2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.2_k0_u0.00001_m0.pdf}};
\node[below = 0cm of A2] (C1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.13_k0_u0.0001_m0.pdf}};
\node[below = -1cm of C1] (C2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.13_k0_u0.0001_m0.pdf}};
\node[right = 0cm of C1] (D1) {\includegraphics[width=0.49\linewidth]{pt_rescue_s0.13_k0_u0.00001_m0.pdf}};
\node[right = 0cm of C2] (D2) {\includegraphics[width=0.49\linewidth]{nt_rescue_s0.13_k0_u0.00001_m0.pdf}};
\node[right = 0.5 of A1, yshift = -2.5cm, rotate = 90, draw, rectangle, rounded corners, thick, fill=gray!50] (s) {\large$\bm{s=0.20}$};
\node[right = 0.5 of C1, yshift = -2.5cm, rotate = 90, draw, rectangle, rounded corners, thick, fill=gray!50] {\large$\bm{s=0.13}$};
...
\centering
\begin{tikzpicture}
\node[] (A1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.2_k100_u0_m0.pdf}};
\node[below = -1cm of A1] (A2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.2_k100_u0_m0.pdf}};
\node[right = 0cm of A1] (B1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.2_k1_u0_m0.pdf}};
\node[right = 0cm of A2] (B2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.2_k1_u0_m0.pdf}};
\node[below = 0cm of A2] (C1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.13_k100_u0_m0.pdf}};
\node[below = -1cm of C1] (C2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.13_k100_u0_m0.pdf}};
\node[right = 0cm of C1] (D1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.13_k1_u0_m0.pdf}};
\node[right = 0cm of C2] (D2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.13_k1_u0_m0.pdf}};
\node[right = 0.5 of A1, yshift = -2.5cm, rotate = 90, draw, rectangle, rounded corners, thick, fill=gray!50] (s) {\large$\bm{s=0.20}$};
\node[right = 0.5 of C1, yshift = -2.5cm, rotate = 90, draw, rectangle, rounded corners, thick, fill=gray!50] {\large$\bm{s=0.13}$};
\node[below = -0.6cm of A2, xshift = 20, draw, rectangle, rounded corners, thick, fill=gray!50] (k) {\large$\bm{\kappa=100}$};
\node[below = -0.6cm of B2, xshift = 20, draw, rectangle, rounded corners, thick, fill=gray!50] {\large$\bm{\kappa=1}$};
...
\centering
\begin{tikzpicture}
\node[] (A1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.2_k0_u0.0001_m0.pdf}};
\node[below = -1cm of A1] (A2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.2_k0_u0.0001_m0.pdf}};
\node[right = 0cm of A1] (B1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.2_k0_u0.00001_m0.pdf}};
\node[right = 0cm of A2] (B2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.2_k0_u0.00001_m0.pdf}};
\node[below = 0cm of A2] (C1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.13_k0_u0.0001_m0.pdf}};
\node[below = -1cm of C1] (C2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.13_k0_u0.0001_m0.pdf}};
\node[right = 0cm of C1] (D1) {\includegraphics[width=0.49\linewidth]{dynamics_rescue_s0.13_k0_u0.00001_m0.pdf}};
\node[right = 0cm of C2] (D2) {\includegraphics[width=0.49\linewidth]{coalescent_rescue_s0.13_k0_u0.00001_m0.pdf}};
\node[right = 0.5 of A1, yshift = -2.5cm, rotate = 90, draw, rectangle, rounded corners, thick, fill=gray!50] (s) {\large$\bm{s=0.20}$};
\node[right = 0.5 of C1, yshift = -2.5cm, rotate = 90, draw, rectangle, rounded corners, thick, fill=gray!50] {\large$\bm{s=0.13}$};
\node[below = -0.6cm of A2, xshift = 20, draw, rectangle, rounded corners, thick, fill=gray!50] (k) {\large$\bm{u=10^{-4}}$};
\node[below = -0.6cm of B2, xshift = 20, draw, rectangle, rounded corners, thick, fill=gray!50] {\large$\bm{u=10^{-5}}$};
...
\centering
\begin{tikzpicture}
\node[] (A) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.2_k100_u0_m0_empirical.pdf}};
\node[right = 0 of A] (B) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.2_k1_u0_m0_empirical.pdf}};
\node[below = 0 of A] (C) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.13_k100_u0_m0_empirical.pdf}};
\node[right = 0 of C] (D) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.13_k1_u0_m0_empirical.pdf}};
...
\centering
\begin{tikzpicture}
\node[] (A) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.2_k0_u0.0001_m0_empirical.pdf}};
\node[right =0 of A] (B) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.2_k0_u0.00001_m0_empirical.pdf}};
\node[below =0 of A] (C) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.13_k0_u0.0001_m0_empirical.pdf}};
\node[right =0 of C] (D) {\includegraphics[width=0.49\linewidth]{EH_rescue_s0.13_k0_u0.00001_m0_empirical.pdf}};
\node[right = 0 of A, xshift = 0.6cm, yshift = -0.5cm, draw, rectangle, rounded corners, thick, fill=gray!50, rotate = 90] (s) {\large$\bm{s=0.20}$};
\node[right = 0 of C,  xshift = 0.6cm, yshift = -0.5cm, draw, rectangle, rounded corners, thick, fill=gray!50, rotate = 90] {\large$\bm{s=0.13}$};
...
\node[right =0 of A] (B) {\includegraphics[width=0.49\linewidth]{TajimasD_rescue_s0.2_k1_u0_m0.pdf}};
\node[below =0 of A] (C) {\includegraphics[width=0.49\linewidth]{TajimasD_rescue_s0.13_k100_u0_m0.pdf}};
\node[right =0 of C] (D) {\includegraphics[width=0.49\linewidth]{TajimasD_rescue_s0.13_k1_u0_m0.pdf}};
\node[right = 0 of A, xshift = 0.6cm, yshift = -0.5cm, draw, rectangle, rounded corners, thick, fill=gray!50, rotate = 90] (s) {\large$\bm{s=0.20}$};
\node[right = 0 of C,  xshift = 0.6cm, yshift = -0.5cm, draw, rectangle, rounded corners, thick, fill=gray!50, rotate = 90] {\large$\bm{s=0.13}$};
\node[below = -2/3 of A, xshift = 20, draw, rectangle, rounded corners, thick, fill=gray!50] (k) {\large$\bm{\kappa=100}$};
\node[below = -2/3 of B, xshift = 20, draw, rectangle, rounded corners, thick, fill=gray!50] {\large$\bm{\kappa=1}$};
...
We chose to use this setup as the constant population size comparison (rather than, say, a Wright-Fisher population) because it allows us to keep the same variance in gamete and offspring numbers (affecting the probability of establishment and the rate of coalescence; see \nameref{sec:simdetails}) as well as the same census population size (affecting initial allele frequency, $p(0)$) as in the case of rescue.
